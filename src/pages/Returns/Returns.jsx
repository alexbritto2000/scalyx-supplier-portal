                        ...
                        <table className="min-w-full text-sm text-left border-collapse">
                            <thead className="text-[#22223B] font-medium">
                                <tr className="border-b border-[#F0F0F0]">
                                    <th className="py-2 px-4">Exp. Arrival</th>
                            ...
                            <tbody className="text-gray-700">
                                ...
                                {filteredReturns.map((returnItem) => (
                                    <tr key={returnItem.id} className="even:bg-[#F5F9F9] hover:bg-gray-50">
                                        <td className="py-3 px-4">{returnItem.expectedArrival}</td>
                                        ...
                                        <td className="py-3 px-4 underline cursor-pointer">
                                            {returnItem.tracking}
                                        </td>
                                        <td className="py-3 px-4">
                                            <div className="flex items-center gap-2">
                                                {returnItem.requestedAction}
                                                {/* {returnItem.status === "Completed" && (
                                                    <img src={RoundedTick} alt="Completed" className="w-4 h-4" />
                                                )} */}
                                            </div>
                                        </td>
                                    </tr>
